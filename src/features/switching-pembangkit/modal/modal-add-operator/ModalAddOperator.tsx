...
import {
  ...
  validationSchema,
  initialValues,
} from "./ModalAddOperator.constant";
...
const ModalAddOperator = () => {
  ...
  const isOpen =
    modalSnapshot.isOpen && modalSnapshot.target === "modal-add-operator";
  ...
  const onSubmit = (event?: React.FormEvent<HTMLFormElement>) => {
    ...
    formMethods.handleSubmit(async (values) => {
      await createPerson({ ...values, status: "operator" });
      setIsAddData(false);
      getPersonList({ status: "operator" });
