...
import { laporanScada } from "../state/laporanScada";
...
const ModalAdd = () => {
  ...
  const { garduIndukOptions, pembangkitOptions, ibtOptions, typeOptions } =
    useModalAdd();
        ...
        <StyledForm noValidate onSubmit={onSubmit}>
          ...
          >
            ...
            <Grid container spacing={1} mt={1}>
              ...
              <Grid item xs={6}>
                <DatePicker label="Tanggal Konfirmasi" name="tanggal_konfirmasi" />
              </Grid>
              <Grid item xs={12}>
